<?php
	...
	$ex=$link->query("select * from senior l where age >79 and (
	    l.idn like'%".$value."%' or
	...
	$ex1=$link->query("select * from senior l where age >79 and (
	   l.idn like'%".$value."%' or
		l.name_fam like'%".$value."%' or		
		l.name_1st like'%".$value."%' or		
		l.name_mid like'%".$value."%' or	
	...
	<div class="container">
		<div class="row">
			<div class="col justify-content-between align-items-center text-center">
				...
				<button class="bmargin btn btn-sm btn-outline-success" type="button" onclick="getID('t_search').value='';jump('senior_grid_80up.php')"><i class="fa fa-sync tpad"></i> <x class="thid">Refresh</x></button>
				<button class="bmargin btn btn-sm btn-outline-dark" type="button" value="List View" onclick="jump('senior_list_80up.php')"><i class="fa fa-list tpad"></i> <x class="thid">List View</x></button>
				<select class="swid bmargin btn btn-sm btn-outline-dark" onchange="if(this.value=='All barangays')jump('senior_grid_80up.php'); else jump('?barangay='+this.value)" >
				...
				<select class="thid bmargin btn btn-sm btn-outline-primary" onchange="if(this.value=='All ages')jump('senior_grid_80up.php'); else jump('?age='+this.value+'&barangay=<?php echo $_GET["barangay"];?>&pensioner=<?php echo $_GET["pensioner"];?>')" >
					<option>Ages</option>
					<?php
				...
				<select class="thid bmargin btn btn-sm btn-outline-secondary" onchange="if(this.value=='With pensions')jump('senior_grid_80up.php'); else jump('?pensioner='+this.value+'&barangay=<?php echo $_GET["barangay"];?>&age=<?php echo $_GET["age"];?>')" >
				...
				<button class="bmargin btn btn-sm btn-outline-primary" type="button" onclick="jump('senior_grid.php')"><i class="fa fa-wheelchair tpad"></i> <x class="thid">SC 80 UP</x></button>
				<?php
