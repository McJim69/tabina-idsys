...
<script> setActive("revstats"); </script>
...
<div class="container my-4">
	...
	<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
		...
		<div class="no-print my-2">
			<button class="btn btn-outline-primary rounded-pill px-3 mr-2" onclick="location.reload()">
		...
		<div class="col-lg-8 mb-4">
			<div class="card analytics-card shadow-sm border h-100 bg-white">
				<div class="card-header bg-transparent font-weight-bold text-dark">
					<i class="fas fa-chart-line mr-2 text-primary"></i>Accumulated Revenue Timeline Trend (Monthly)
				</div>
	...
	<div class="row">
		...
		<div class="col-lg-5 mb-4">
			<div class="card analytics-card shadow-sm border h-100 bg-white">
				<div class="card-header bg-transparent font-weight-bold text-dark">
					<i class="fas fa-chart-bar mr-2 text-info"></i>Transaction Volume per Service Category
				</div>
				<div class="card-body d-flex align-items-center justify-content-center">
