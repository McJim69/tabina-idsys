	...
	<div class="container">
		<div class="row">
			<div class="col justify-content-between align-items-center text-center">
				<button class="bmargin btn btn-sm btn-outline-info" type="button" onclick="jump('employees_idcard.php')"><i class="fa fa-sync"></i> Refresh</button>
				<button class="bmargin btn btn-sm btn-outline-info" type="button" onclick="jump('employees_list.php')"><i class="fa fa-list"></i> List</button>
				<button class="bmargin btn btn-sm btn-outline-info" type="button" onclick="jump('employees_grid.php')"><i class="fa fa-th"></i> Grid</button>
				<button class="bmargin btn btn-sm btn-outline-info" type="button" onclick="printF()"><i class="fa fa-print"></i> Print</button>		
				<?php
					if(!isset($_SESSION['user'])){
						echo"";
					}else
						echo"
					<a rel='facebox' href='employees_add.php'><button class='bmargin btn btn-sm btn-outline-success' type='button'><i class='fa fa-plus'></i> Add</button></a>";
				?>			
			</div>				
		</div>
	</div>
		...
		$p=$_GET['page'];
			...
			echo "
				...
				if(file_exists("images/employees/signatures/$rs[0].png")){
					echo"<img src='images/employees/signatures/$rs[0].png?".date("h:i:s")."' height='30px'/><br/>";
				}else{
