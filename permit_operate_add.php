<?php
	...
	$squery = "SELECT MAX(idn) FROM permit_operate";
...
<div class="card border-0 shadow-none">
    ...
    <div class="card-header bg-primary text-white py-3 px-4 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 font-weight-bold text-white">
            <i class="fas fa-truck mr-2"></i>Permit to Operate Form: <b><?php echo $lastID;?></b>
        </h5>
    </div>

    <!-- Modal Body -->
    <div class="card-body p-4" style="max-height: 80vh; overflow-y: auto;">
        <form action="permit_operate_add_proc.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="idn" value="<?php echo $lastID;?>" />
			<input type="hidden" name="province" value="ZDS" />

            <!-- Trade Name & Nature of Activity -->
            <div class="form-row mb-3">
                <div class="col-md-5 mb-2">
                    <label class="small font-weight-bold text-muted text-uppercase mb-1">Trade Name</label>
                    <input class="form-control" required name="tradename" type="text" placeholder="Trade Name" autofocus />
                </div>
            ...
            <div class="d-flex align-items-center justify-content-end border-top pt-3">
                <button type="submit" name="bSave" class="btn btn-primary px-4 font-weight-bold shadow-sm">
                    <i class="fas fa-save mr-1"></i> Submit Permit
                </button>
            </div>
        </form>
    </div>
