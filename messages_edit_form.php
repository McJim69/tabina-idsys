...
<?php
	...
	$msg="";
	if(isset($_GET["messages"]) && $_GET["messages"]!="")
		$msg=" and idn='".$_GET["messages"]."' ";
										
	$ex=$link->query("select * from messages where idn=idn $msg order by idn limit $from,$to ");
...
<div class="card border-0 shadow-none">
    ...
    <div class="card-body p-4" style="max-height: 80vh; overflow-y: auto;">
        <form action="messages_edit_proc.php" method="POST">
