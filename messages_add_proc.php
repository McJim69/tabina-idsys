<?php
	...
	if(isset($_POST["bSave"])){
		...
		$insert = $link->query("INSERT INTO messages (
		...
		if(($insert) == TRUE){
			...
			logAuditTrail($link, $admin, "Sent Inbox Message (ID: " . $_POST["idn"] . ")");


			$idn = $_POST["idn"];
			$data = "From: ".$_POST["msg_from"]." To: ".$_POST["msg_to"]." \n Message ID: ".$_POST["idn"]." Date: ".date("d-m-Y", strtotime($_POST["date_msg"]))."";		
			$tempDir = "images/messages/qrcodes/";
			$codeContents =  "".$data."";
			$fileName = "".$idn.".png";
