<?php
	...
	$insert = $link->query("INSERT INTO permit_business (
		...
		if(($insert) == TRUE){
			...
			logAuditTrail($link, $admin, "Created new Business Permit record: " . $_POST['tradename'] . " (Owned by: " . $fullname . ", ID: " . $_POST["idn"] . ")");


			$fullname = trim($_POST['name_1st'] . " " . $_POST['name_mid'] . " " . $_POST['name_fam']);

			$idn = "".$_POST["idn"]."";
			$data = "".$_POST["tradename"]."\nBP-".$idn."-".date("d-m-Y", strtotime($_POST["date_issued"]))."";		
