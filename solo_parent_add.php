...
<div class="card border-0 shadow-none">
    ...
    <div class="card-header bg-primary text-white py-3 px-4 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 font-weight-bold text-white">
            <i class="fas fa-user-plus mr-2"></i>Add Solo Parent <b><?php echo $lastID;?></b>
        </h5>
    </div>

    <!-- Modal Body -->
    <div class="card-body p-4" style="max-height: 80vh; overflow-y: auto;">
        <form action="solo_parent_add_proc.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="idn" value="<?php echo $lastID;?>"/>
			<input type="hidden" name="province" value="ZDS"/>
			<input type="hidden" name="assoc_id_no" value="" />
            ...
            <div class="form-row mb-3">
                ...
                <div class="col-md-2 mb-2">
                    ...
                    <select class="form-control" name="name_mid">
                        <option value="" <?php if (empty($Mname_mid)) echo 'selected'; ?>>MI</option>
                        <?php foreach(range('A','Z') as $char){ 
                            $sel = ($Mname_mid === $char || strpos($Mname_mid, $char) === 0) ? 'selected' : '';
            ...
            <div class="form-row mb-3">
                <div class="col-md-4 mb-2">
                    ...
                    <input class="form-control" onfocus="(this.type='date')" name="date_birth" placeholder="Date of Birth" value="<?php echo htmlspecialchars($birth_val); ?>" required>
                </div>
                <div class="col-md-4 mb-2">
           ...
           <!-- Address Section -->
            ...
            <div class="form-row mb-3">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input class="form-control" name="email" type="email" placeholder="Email Address" value="<?php echo htmlspecialchars($email_val); ?>" />
                </div>
                <div class="col-md-4 mb-2">
            ...
            <div class="form-row mb-3">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input class="form-control" onfocus="(this.type='date')" name="date_app" placeholder="Date of Applied" required>
                </div>
            </div>
            <!-- Emergency Contact -->
            ...
            <div class="form-row mb-4">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input class="form-control" type="date" name="date_interview" value="<?php echo date('Y-m-d'); ?>" required />
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-end border-top pt-3">
                <button type="submit" name="bSave" class="btn btn-primary px-4 font-weight-bold shadow-sm">
                    <i class="fas fa-save mr-1"></i> Submit Solo Parent
                </button>
            </div>
        </form>
    </div>
