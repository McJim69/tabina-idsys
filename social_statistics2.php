	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-12">
			<div class="chart-container">
				<h4 class="chart-title">Social <x class="thid">Registries</x> Size Comparison</h4>
	...
	new Chart(ctxReg, {
		...
		options: {
			...
			scales: {
				y: {
					beginAtZero: true,
					title: { display: true, text: 'Registered Count', color: '#4b5563', font: { weight: 'bold' } }
				}
			}
		}
	});
	...
	new Chart(ctxGender, {
		...
		options: {
			...
			scales: {
				y: {
					beginAtZero: true,
					title: { display: true, text: 'Count', color: '#4b5563', font: { weight: 'bold' } }
				}
			}
		}
	});
