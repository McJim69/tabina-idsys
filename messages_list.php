...
<script> setActive("msginlist"); </script>
	...
	<div class="container">
		<div class="row">
			<div class="col justify-content-between align-items-center text-center">
				...
				<button class="bmargin btn btn-sm btn-info" type="button" onclick="jump('messages_grid.php')"/><i class="fa fa-th tpad"></i> <x class="thid">Grid View</x></button>
				...
				<select class="swid spad bmargin btn btn-sm btn-outline-primary" onchange="if(this.value=='Messages From')jump('messages_list.php'); else jump('messages_list.php?messages='+this.value+'')">
				...
				<button class="bmargin btn btn-sm btn-warning" type="button" onclick="getID('t_search').value='';jump('messages_list.php')"><i class="fa fa-sync tpad"></i> <x class="thid">Refresh</x></button>                                                  
				<a rel='facebox' href='messages_add.php'><button class="bmargin btn btn-sm btn-success" type='button'><i class="fa fa-plus tpad"></i> <x class="thid">Add Message</x></button></a>
			</div>				
		</div>
		<div class="row">
        ...
        <table align="center" style="margin:0 auto;">
            <tr>
                ...
                <td class="px-3 text-center">
                    <b style="font-size:16px;text-transform:uppercase">Incoming Communications Log</b>
    ...
    <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
        <div class="card-header bg-primary text-white py-3 d-flex align-items-center justify-content-between">
            <h6 class="mb-0 font-weight-bold">
                <i class="fas fa-inbox mr-2"></i>Incoming <x class="thid">Messages Log</x>
            </h6>
            ...
            <table class="table table-hover table-striped align-middle mb-0" style="font-size: 13px;">
                <thead class="thead-dark text-uppercase font-weight-bold">
                    <tr>
                        ...
                        <th width="14%"><x class="thid">Message</x> Content</th>
                    </tr>
                </thead>
                <tbody>
                <?php
				...
				if (!empty($rs['date_confirm']) && $rs['date_confirm'] !== '0000-00-00') {
					...
					$rs['confirm_year'] = '';
                        ...
                        if($ctr<=$rec){
                            ...
                            echo "<tr class='tr-hover' style='cursor:pointer;' onclick=\"jump('messages_pds.php?messages=".$rs[0]."')\">";
