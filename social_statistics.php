...
<script>setActive("sosstats");</script>
...
<div class="container py-4" style="margin-top:50px;">
	...
	<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
		<div>
			<h2 class="font-weight-bold text-dark mb-1">
				<i class="fas fa-users mr-2 text-primary"></i>Social Services <x class="thid">Status</x>
			</h2>
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-12">
			<div class="chart-container">
				<h4 class="chart-title">Social Registries Size Comparison</h4>
		...
		<div class="col-lg-6 col-md-12">
			<div class="chart-container">
				<h4 class="chart-title">Gender Distribution Across Groups</h4>
				<div style="position: relative; height: 320px;">
	...
	<div class="row">
		<div class="col-12">
			<div class="chart-container">
				<h4 class="chart-title">Barangay Social Welfare Directory</h4>
				<div class="table-responsive">
					<table class="modern-table">
						<thead>
							<tr>
								<th style="width: 20%;">Barangay</th>
								<th class="text-center" style="width: 11%;">Seniors</th>
								<th class="text-center" style="width: 11%;">Kinder</th>
								<th class="text-center" style="width: 11%;">PWDs</th>
								<th class="text-center" style="width: 12%;">Solo Parents</th>
								<th class="text-center" style="width: 11%;">Indigents</th>
								<th class="text-center" style="width: 12%;">Households</th>
								<th class="text-center" style="width: 12%;">Total</th>
							</tr>
						</thead>
						<tbody>
							<?php foreach($barangays as $b_name => $counts){ ?>
								<tr>
									<td class="font-weight-bold"><?php echo htmlspecialchars($b_name); ?></td>
									<td class="text-center text-primary"><?php echo number_format($counts['senior']); ?></td>
									<td class="text-center text-success"><?php echo number_format($counts['kinder']); ?></td>
									<td class="text-center text-warning"><?php echo number_format($counts['pwd']); ?></td>
									<td class="text-center text-info"><?php echo number_format($counts['solo']); ?></td>
									<td class="text-center text-danger"><?php echo number_format($counts['indigents']); ?></td>
									<td class="text-center text-secondary"><?php echo number_format($counts['households']); ?></td>
									<td class="text-center"><span class="badge badge-dark py-1 px-2" style="font-size: 13px;"><?php echo number_format($counts['total']); ?></span></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
