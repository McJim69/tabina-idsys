<?php
	...
	$squery = "SELECT MAX(idn) FROM kinder";
...
<div class="card border-0 shadow-none">
    ...
    <div class="card-header bg-primary text-white py-3 px-4 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 font-weight-bold text-white">
            <i class="fas fa-child mr-2"></i>Kindergarten Form
        </h5>
    </div>

    <!-- Modal Body -->
    <div class="card-body p-4" style="max-height: 80vh; overflow-y: auto;">
        <form action="kinder_add_proc.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row mb-3">
                <div class="col-md-5 mb-2">
                    ...
                    <input class="form-control" required name="name_1st" type="text" placeholder="First Name" autofocus />
                </div>
                <div class="col-md-2 mb-2">
                    <label class="small font-weight-bold text-muted text-uppercase mb-1">M.I.</label>
                    <input class="form-control" name="name_mid" placeholder="M.I." maxlength="2" />
                </div>
                <div class="col-md-5 mb-2">
                    <label class="small font-weight-bold text-muted text-uppercase mb-1">Family Name</label>
                    <input class="form-control" required name="name_fam" type="text" placeholder="Family Name" />
                </div>
            </div>
            ...
            <div class="form-row mb-4">
                <div class="col-md-6 mb-2">
                    ...
                    <input class="form-control" required name="parent" type="text" placeholder="Name of Parent or Guardian" />
                </div>
                <div class="col-md-6 mb-2">
            ...
            <div class="d-flex align-items-center justify-content-end border-top pt-3">
                <button type="submit" name="bSave" class="btn btn-primary px-4 font-weight-bold shadow-sm">
                    <i class="fas fa-save mr-1"></i> Submit Child Entry
                </button>
            </div>
        </form>
    </div>
