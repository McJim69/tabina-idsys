...
<script> setActive("hhsstats"); </script>
	...
	<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
		<div>
			<h2 class="font-weight-bold text-primary mb-1">
				<i class="fas fa-chart-bar mr-2"></i>Households <x class="thid">Advanced Analytics</x>
			</h2>
		...
		<div class="no-print my-2">
			<button class="hid btn btn-outline-primary rounded-pill px-3 mr-2" onclick="location.reload()">
				<i class="fas fa-sync-alt mr-1"></i> Refresh Data
			</button>
			<button class="hid btn btn-primary rounded-pill px-3" onclick="printF()">
...
<script>
	...
	<div class="row">
		...
		<div class="col-lg-6 mb-4">
			<div class="card analytics-card shadow-sm border h-100 bg-white">
				<div class="card-header bg-transparent font-weight-bold text-dark">
					<i class="fas fa-recycle mr-2 text-success"></i>Solid Waste Management Adoption (Household Count)
				</div>
		...
		<div class="col-lg-6 mb-4">
			<div class="card analytics-card shadow-sm border h-100 bg-white">
				<div class="card-header bg-transparent font-weight-bold text-dark">
					<i class="fas fa-road mr-2 text-primary"></i>Average Distance to Core Public Facilities (km)
				</div>
				<div class="card-body d-flex align-items-center justify-content-center">
